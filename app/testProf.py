...
# récupérant le dernier numéro de photos +1 car la sauvegarde des noms de photos est n.png,
# Pour chaque nom de fichier n, on trouve la position du . et on extrait jusqu'à la position du .
# sorted trie la liste en descendant
...
# Message
print("\n\033[94mLe programme va enregistrer " + str(count_max) +
      " photos. Veuillez bouger la tête pour prendre des photos de face différenciées.\033[0m\n")

# Boucle sur le nombre de photos attendues
count = 0
pause = 0
...
while count < count_max:
    ...
    while(not rval):
        ...
        (rval, frame) = picam2.capture_array()
        if(not rval):
